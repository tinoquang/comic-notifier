...
func (h *Handler) handleText(msg Messaging, timeout int) {
...
func (h *Handler) handlePostback(msg Messaging, timeout int) {
...
func (h *Handler) handleQuickReply(msg Messaging, timeout int) {
